...
<div class="container-fluid">
	...
	<?php
		...
		// set product property values
			...
			// update the user
			if ($user->update()) {
				$_SESSION['msg'] = 'แก้ไขข้อมูลแล้ว';
			} else {
				$_SESSION['msg'] = "ไม่สามารถแก้ไขข้อมูลได้ โปรดตรวจสอบ";
			}
				...
				<tr>
					...
					<td>
						<select name="user_role" class="form-control">
							<option value='<?php echo $user->user_role; ?>' class='form-control' required><?php echo $user->user_role; ?></option>
