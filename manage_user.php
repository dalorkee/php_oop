...
<div class="container-fluid">
	...
	<?php
		...
		// display the users
		if ($num > 0) {
			echo"<a href='create_user.php' class='btn btn-success btn-sm mb-2'><i class='fa fa-user-plus'></i> สร้างผู้ใช้ใหม่</a>";
			...
			while ($row = $result->fetch_array()) {
				...
				echo "<tr>";
					...
					echo "<td>";
						...
						echo "<a href='delete_user.php?id={$id}' onclick='del({$id})'>Delete</a>";
					echo "</td>";
				echo "</tr>"; 
			}
			echo "</table>";
		} else {
			echo "<div>ไม่พบข้อมูลในฐานข้อมูล</div>";
		}
	?>
	</div>
	<footer class="footer">
